...
// router.post('/tenant/google-auth', asyncHandler(authController.googleAuth.bind(authController)))
...
// router.post('/tenant/refresh',asyncHandler(authController.refreshToken.bind(authController)))
// router.get('/tenant/me', authenticateToken,tenantOrLandlord, asyncHandler(authController.getMe.bind(authController)));
// router.post('/tenant/logout',authenticateToken,asyncHandler(authController.logout.bind(authController)))
