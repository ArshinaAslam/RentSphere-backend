...
export class TenantVisitController {
  ...
  async getBookedSlots(req: AuthRequest, res: Response): Promise<Response> {
    ...
    if (!propertyId || !date) {
      return res
        ...
        .json(ApiResponses.error(MESSAGES.VISIT.SLOT_REQUIRED));
    }
    ...
    return res
      ...
      .json(
        ApiResponses.success(
          { bookedSlots },
          MESSAGES.VISIT.BOOKED_SLOTS_SUCCESS,
        ),
      );
  }
  ...
  async bookVisit(req: AuthRequest, res: Response): Promise<Response> {
    ...
    if (!tenantId) {
      return res
        ...
        .json(ApiResponses.error(MESSAGES.VISIT.UNAUTHORIZED));
    }
    ...
    if (!dto.propertyId || !dto.landlordId || !dto.date || !dto.timeSlot) {
      return res
        .status(HttpStatus.BAD_REQUEST)
        .json(ApiResponses.error(MESSAGES.VISIT.REQUIRED_FIELDS));
    }
    ...
    return res
      ...
      .json(ApiResponses.success(null, MESSAGES.VISIT.BOOK_SUCCESS));
  }
  ...
  async getTenantVisits(req: AuthRequest, res: Response): Promise<Response> {
    ...
    return res
      .status(HttpStatus.OK)
      .json(ApiResponses.success({ visits }, MESSAGES.VISIT.FETCH_SUCCESS));
  }
  ...
  async cancelVisit(req: AuthRequest, res: Response): Promise<Response> {
    ...
    if (!visitId) {
      return res
        .status(HttpStatus.BAD_REQUEST)
        .json(ApiResponses.error(MESSAGES.VISIT.VISIT_ID_REQUIRED));
    }
    ...
    return res
      .status(HttpStatus.OK)
      .json(ApiResponses.success(null, MESSAGES.VISIT.CANCEL_SUCCESS));
  }
}
