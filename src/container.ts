...
container.registerSingleton(DI_TYPES.AdminLandlordService,AdminLandlordService)
...
container.registerSingleton(DI_TYPES.LandlordKycController,LandlordKycController)
container.registerSingleton(DI_TYPES.AdminAuthController,AdminAuthController)
container.registerSingleton(DI_TYPES.AdminTenantController,AdminTenantController)
container.registerSingleton(DI_TYPES.AdminLandlordController,AdminLandlordController)
